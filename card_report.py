...
#
# โทนอุ่นทั้งชุด (แดงอิฐ / ทอง / กุหลาบ / ส้มอ่อน) ไม่ใช่สีแดงเฉดเดียวไล่อ่อน
# ไปเข้ม เพราะทั้งสี่เป็นคนละชนิดงานกัน ไม่ได้เรียงมากน้อย ถ้าใช้เฉดเดียวคนดู
# จะแยกชั้นในแท่งซ้อนไม่ออก โดยเฉพาะคนตาบอดสี
#
# ตรวจด้วยเครื่องมือวัดแล้ว คู่ที่ติดกันห่างกันน้อยสุด ΔE 17.0 (เกณฑ์ 15) ทั้ง
# สายตาปกติและตาบอดสีทุกแบบ ผ่านย่านความสว่างและความอิ่มสีของพื้นหลังสว่าง
# ซึ่งเป็นธีมที่กลุ่มใช้จริง
#
# ชุดนี้ไม่ผ่านย่านความสว่างของธีมมืด (ทองกับส้มสว่างเกินเพดาน 0.67) ชุดโทนอุ่น
# ที่ผ่านทั้งสองธีมมีอยู่จำนวนมาก แต่เท่าที่ค้นเจอทุกชุดต้องให้ม่วงแดงมาเป็นสี
# แรก ซึ่งจะไปตกที่ AutoPacking ที่เป็นก้อนใหญ่สุดของแท่ง แล้วภาพรวมจะไม่อ่าน
# เป็นโทนแดงอีกต่อไป จึงเลือกให้ธีมสว่างอ่านดีไว้ก่อน
CHART_COLORS = ["#B93A2E", "#C99A0F", "#A94070", "#E08050"]
