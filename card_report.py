...
#
# แยกชั้นด้วยความสว่างเป็นหลัก (เกือบดำ / เทาอ่อน / แดงเข้ม / ชมพู) ไม่ใช่
# ด้วยเฉดสีหลายสี แท่งซ้อนที่มีก้อนใหญ่ก้อนเดียวครองพื้นที่แบบนี้ การไล่
# ความสว่างอ่านง่ายกว่า และยังคงโทนแดงตามที่ต้องการ
#
# ตรวจด้วยเครื่องมือวัดแล้ว คู่ที่ติดกันห่างกันน้อยสุด ΔE 27.9 จากเกณฑ์ 15
# ทั้งสายตาปกติและตาบอดสีทุกแบบ สูงกว่าชุดหลายเฉดที่เคยใช้ (17.0)
#
...
CHART_COLORS = ["#101010", "#D9D9D9", "#BF0F01", "#FFA8A5"]
