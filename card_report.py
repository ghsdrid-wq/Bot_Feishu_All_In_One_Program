...
#
# แยกชั้นด้วยความสว่างเป็นหลัก (แดงเข้ม / เทาอ่อน / เกือบดำ / ชมพู) ไม่ใช่
# ด้วยเฉดสีหลายสี แท่งซ้อนที่มีก้อนใหญ่ก้อนเดียวครองพื้นที่แบบนี้ การไล่
# ความสว่างอ่านง่ายกว่า และยังคงโทนแดงตามที่ต้องการ
#
# ตรวจด้วยเครื่องมือวัดแล้ว คู่ที่ติดกันห่างกันน้อยสุด ΔE 37.4 จากเกณฑ์ 15
# ทั้งสายตาปกติและตาบอดสีทุกแบบ สูงกว่าชุดหลายเฉดที่เคยใช้ (17.0) เท่าตัว
#
# ลำดับสำคัญ: เทากับชมพูห่างกันแค่ ΔE 7.8 จึงต้องไม่ให้อยู่ติดกันในแท่ง
# สลับลำดับเมื่อไหร่ต้องวัดใหม่
#
# ข้อแลกเปลี่ยน: สีเกือบดำจะจมไปกับพื้นหลังของธีมมืด (contrast 1.09) กลุ่ม
# ที่ใช้อยู่เป็นธีมสว่าง จึงเลือกให้ธีมสว่างอ่านดีไว้ก่อน
CHART_COLORS = ["#BF0F01", "#D9D9D9", "#101010", "#FFA8A5"]
